...
- 2026-07-14 → 2026-07-16 — booking platform built as a **speculative pitch** — a
  demonstration of what Jamie can do, not commissioned work. Deployed at
  vinecliff.vercel.app.
- 2026-08-11 — Billy's own footage (ten `.mov` files) added to the repo — client-supplied,
  waiting to be used.
- 2026-08-13 — last touch. **Billy has seen the live platform**; he is very busy.
- 2026-08-26 — adopted into the pipeline by the ICM-011 sweep, at `01_intake`.
...
- 2026-09-23 — folder renamed from `billy-carlson` to `vinecliff`: the slug is now the repo name (Jamie's decision, 2026-09-23; decision D28).
