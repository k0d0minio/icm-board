# ICM-006 · House discovery templates in _system/discovery/
...
reinvents the artifacts. Distinct from `JN-021` (in the `jamienisbet` repo): these are working documents for Jamie,
...
.icm/intake/ICM-006-house-discovery-templates.md for full context, then distill the real
