...
reconciled — the metric that says whether the ritual is alive. The heartbeat (ICM-001)
...
Give /day a durable run log. Read .icm/intake/ICM-002-day-run-log.md for full context.
...
(_system/scripts/heartbeat.sh, from ICM-001) to report the age of the last line. This is
