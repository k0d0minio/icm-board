...
A blocking operator act is written here **and** in the stop report's `Operator:` checklist; a
non-blocking one lives only in that checklist, never here (`_shared/output.md` → Split by actor).
