---
description: "Read-only executor for the forked audit skills (codebase-audit, production-readiness). Reads wide, returns one structured report, never modifies the repository. Not for general delegation — the audit skills fork into it via their `agent: auditor` frontmatter."
mode: subagent
permission:
  edit: deny
---
