---
description: The estate ticket ritual — reconcile the board, pick today's ≤10, or close out a session. Ends as one merged ticket PR per client repo, into its ticket base branch, and icm-board's own commits pushed to main.
